...
public final class DocumentsAdapter extends androidx.recyclerview.widget.RecyclerView.Adapter<com.raywenderlich.android.majesticreader.presentation.library.DocumentsAdapter.ViewHolder> {
    ...
    private final java.util.List<com.raywenderlich.android.majesticreader.Document> documents = null;
    @org.jetbrains.annotations.NotNull
    private final com.bumptech.glide.RequestManager glide = null;
    @org.jetbrains.annotations.NotNull
    private final kotlin.jvm.functions.Function1<com.raywenderlich.android.majesticreader.Document, kotlin.Unit> itemClickListener = null;
    
    public DocumentsAdapter(@org.jetbrains.annotations.NotNull
    java.util.List<com.raywenderlich.android.majesticreader.Document> documents, @org.jetbrains.annotations.NotNull
    com.bumptech.glide.RequestManager glide, @org.jetbrains.annotations.NotNull
    kotlin.jvm.functions.Function1<? super com.raywenderlich.android.majesticreader.Document, kotlin.Unit> itemClickListener) {
        super();
    }
    ...
    java.util.List<com.raywenderlich.android.majesticreader.Document> newDocuments) {
    }
